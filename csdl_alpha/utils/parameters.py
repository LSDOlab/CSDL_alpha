...
class Parameters(object):
    ...
    def hold(self, in_dict: Dict[str, Any]):
        """
        Holds the given dictionary of parameters to be added when declared.

        **Parameters**

        in_dict :  (Dict[str, Any])
            The dictionary of parameters to be held until declared.
        """
        self.pending = in_dict

    def check(self, in_dict: Dict[str, Any]):
        """
        Check the given dictionary of parameters against declared options.

        **Parameters**

        in_dict : dict
            The dictionary of parameters to be checked against declared options.
        """
        for name in in_dict:
