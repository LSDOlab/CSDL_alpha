...
#             analytical_derivative_values[(of, wrt)]['value'] = deriv[wrt].value
#             analytical_derivative_values[(of, wrt)]['fd_value'] = finite_differenced_values[of,wrt]

#             if of_wrt_meta_data is not None:
#                 if (of, wrt) in of_wrt_meta_data:
#                     analytical_derivative_values[(of, wrt)]['max_rel_error'] = of_wrt_meta_data[of, wrt]['max_rel_error']
#                     analytical_derivative_values[(of, wrt)]['tag'] = of_wrt_meta_data[of, wrt]['tag']
#             analytical_derivative_values[(of, wrt)]['of_name'] = of_name_dict[of]
#             analytical_derivative_values[(of, wrt)]['wrt_name'] = wrt_name_dict[wrt]
